...
clean-Core-2f-application-2f-tasks:
	-$(RM) ./Core/application/tasks/fast_task.cyclo ./Core/application/tasks/fast_task.d ./Core/application/tasks/fast_task.o ./Core/application/tasks/fast_task.su ./Core/application/tasks/medium_task.cyclo ./Core/application/tasks/medium_task.d ./Core/application/tasks/medium_task.o ./Core/application/tasks/medium_task.su ./Core/application/tasks/slow_task.cyclo ./Core/application/tasks/slow_task.d ./Core/application/tasks/slow_task.o ./Core/application/tasks/slow_task.su ./Core/application/tasks/task_manager.cyclo ./Core/application/tasks/task_manager.d ./Core/application/tasks/task_manager.o ./Core/application/tasks/task_manager.su
