...
C_SRCS += \
../Core/config/acu_lv_config.c 

OBJS += \
./Core/config/acu_lv_config.o 

C_DEPS += \
./Core/config/acu_lv_config.d 
...
clean-Core-2f-config:
	-$(RM) ./Core/config/acu_lv_config.cyclo ./Core/config/acu_lv_config.d ./Core/config/acu_lv_config.o ./Core/config/acu_lv_config.su
