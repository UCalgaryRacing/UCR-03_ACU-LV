...
C_SRCS += \
../Core/config/can/can_config.c 

OBJS += \
./Core/config/can/can_config.o 

C_DEPS += \
./Core/config/can/can_config.d 


# Each subdirectory must supply rules for building sources it contributes
Core/config/can/%.o Core/config/can/%.su Core/config/can/%.cyclo: ../Core/config/can/%.c Core/config/can/subdir.mk
...
clean: clean-Core-2f-config-2f-can

clean-Core-2f-config-2f-can:
	-$(RM) ./Core/config/can/can_config.cyclo ./Core/config/can/can_config.d ./Core/config/can/can_config.o ./Core/config/can/can_config.su

.PHONY: clean-Core-2f-config-2f-can
