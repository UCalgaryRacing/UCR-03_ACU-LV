...
C_SRCS += \
../Core/config/acu_lv/acu_lv_config.c 

OBJS += \
./Core/config/acu_lv/acu_lv_config.o 

C_DEPS += \
./Core/config/acu_lv/acu_lv_config.d 


# Each subdirectory must supply rules for building sources it contributes
Core/config/acu_lv/%.o Core/config/acu_lv/%.su Core/config/acu_lv/%.cyclo: ../Core/config/acu_lv/%.c Core/config/acu_lv/subdir.mk
...
clean: clean-Core-2f-config-2f-acu_lv

clean-Core-2f-config-2f-acu_lv:
	-$(RM) ./Core/config/acu_lv/acu_lv_config.cyclo ./Core/config/acu_lv/acu_lv_config.d ./Core/config/acu_lv/acu_lv_config.o ./Core/config/acu_lv/acu_lv_config.su

.PHONY: clean-Core-2f-config-2f-acu_lv
